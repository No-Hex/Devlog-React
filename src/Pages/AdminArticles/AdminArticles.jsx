    ...
    return (
        <div className="">
            <div className="flex lg:justify-between sm:justify-center">
                ...
                <div className="">
                    <button className='flex justify-center space-x-2  items-center text-gray-200 border-2 border-gray-200 px-2 rounded hover:text-gray-900 hover:bg-gray-200 ease-in duration-300'>New Article</button>
                </div>
            </div>
                ...
                <div className="flex justify-between">
                    <div className="flex space-x-10 items-center">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="">
                                <button className='text-gray-200 hover:bg-gray-200 hover:text-gray-900 border-2 border-gray-200 px-8  rounded '>Add Post</button>
                            </div>
                        </div>
                    </div>
